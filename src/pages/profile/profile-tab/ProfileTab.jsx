...
const MyProfileTab = ({ user }) => {
    ...
    return (
        <div className='profile-tab'>
            <div className='profile-tab__title'>My Profile</div>
            <div className='profile-tab__content'>
                {myProfileData.map((item, index) => (
                    <div key={index} className='profile-tab__content__item'>
                        <div className='profile-tab__content__item__text'>
                            {item.title}
                        </div>
                        <input
                            className='profile-tab__content__item__input'
                            value={item.data}
                            disabled
                        />
                    </div>
...
const EditProfileTab = ({ user, updateInfo }) => {
    ...
    return (
        <div className='profile-tab'>
            <div className='profile-tab__title'>Edit Profile</div>
            <div className='profile-tab__content'>
            ...
            <div className='profile-tab__btnUpdate'>
